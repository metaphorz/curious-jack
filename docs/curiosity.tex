...
\begin{itemize}[nosep]
  \item \textsf{Export Markdown} --- downloads a \texttt{report.md} file
        containing the full report: parameters, subject image (embedded
        as base64), all questions, answers, and standards. The file is
        also saved server-side to \texttt{images/<label>/report.md}
